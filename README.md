...
- **Elfe** : Incantation, Familier, Patron, Corruption, Traits elfiques, Grille de sorts (2 sorts de patron figés : Lier un patron / Invoquer un Patron (___/jour) saisissable)
